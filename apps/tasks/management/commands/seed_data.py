...
class Command(BaseCommand):
    ...
    def _create_tasks(self, today, departments, teams, users):
        rows = [
            ...
            ("month", "Подготовить рабочие места для стажёров", "АХО", "maria", "new", "medium", 18, 15),
            ("week", "Проверить переговорные перед мероприятием", "АХО", "alexey", "in_progress", "medium", 4, 45),
            ("quarter", "Обновить программу адаптации новичков", "HR", "olga", "new", "medium", 45, 20),
            ...
            ("quarter", "Провести оценку вовлечённости сотрудников", "HR", "olga", "new", "medium", 40, 5),
            ...
            ("quarter", "Провести инвентаризацию оборудования переговорных", "АХО", "alexey", "new", "medium", 28, 10),
            ...
            ("year", "Внедрить единый контроль бюджетов подразделений", "Финансы", "elena", "new", "high", 190, 10),
            ...
            ("week", "Подготовить управленческую сводку для руководства", "Проектный офис", "natalia", "new", "critical", 2, 15),
